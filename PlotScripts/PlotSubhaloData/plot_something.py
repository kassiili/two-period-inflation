...
plot.add_data(SM_vs_Vmax_data(LCDM_dataset), 'red')
plot.add_data(SM_vs_Vmax_data(mock_dataset), 'blue')

#plot = plot_subhalo_dist_vs_vmax(1)
#plot.add_data(subhalo_dist_vs_vmax_data(LCDM_dataset), ['lightblue', 'blue'])
#plot.add_data(subhalo_dist_vs_vmax_data(mock_dataset), ['pink', 'red'])

#plot = plot_rmax_vs_vmax(0)
#plot.add_data(rmax_vs_vmax_data(LCDM_dataset), 'red')
#plot.add_data(rmax_vs_vmax_data(mock_dataset), 'blue')
