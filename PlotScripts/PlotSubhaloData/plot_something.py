...
plot = plot_subhalo_dist_vs_vmax()
plot.add_data(subhalo_dist_vs_vmax_data(LCDM_z0_dataset, 2), ['lightblue', 'blue'], 'galaxy')
plot.add_data(subhalo_dist_vs_vmax_data(LCDM_z0_dataset, 1), ['pink', 'red'], 'galaxy')
